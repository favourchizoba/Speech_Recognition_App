...
def main():
    ...
    st.write('This technology utilizes algorithms and machine learning models to analyze audio input, identify spoken words, and transcribe them into written text.') 
